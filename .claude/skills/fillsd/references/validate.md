...
1. **Prepare a scratch state.** Use one of (choose the safest available for the environment):
   - `git worktree add` uma cópia descartável e mutar lá (preferido: `git stash` é global e destrói estado se houver subagente ou o usuário editando em paralelo); OR
