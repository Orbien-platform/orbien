...
| `.claude/skills/fillsd/scripts/lessons.py` | package | The only way to mutate lessons. |
...
```bash
python3 .claude/skills/fillsd/scripts/lessons.py add \
...
```bash
python3 .claude/skills/fillsd/scripts/lessons.py penalize --id L-NNN
```
...
python3 .claude/skills/fillsd/scripts/lessons.py list --status confirmed

# Or filter by the area this feature touches:
python3 .claude/skills/fillsd/scripts/lessons.py list --status confirmed --scope billing
python3 .claude/skills/fillsd/scripts/lessons.py list --status confirmed --query "idempotency"
```
