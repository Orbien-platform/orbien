...
| MOB-10 | P3: Preferências de notificação | Design | In Design — `.specs/features/preferencias-notificacao-mobile/` |
...
MOB-12), 1 em Design (MOB-10, P3 — feature própria
`.specs/features/preferencias-notificacao-mobile/`, iniciada em 2026-09-11).
