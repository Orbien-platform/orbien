...
|---|---|---|---|
| MOB-01 | P1: Autenticação e sessão | Design | Pending |
| MOB-02 | P1: Autenticação e sessão (refresh serializado) | Design | Pending |
| MOB-03 | P1: Tema por tenant | Design | Pending |
