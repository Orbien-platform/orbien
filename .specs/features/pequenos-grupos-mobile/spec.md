...
|---|---|---|---|
| MOB-09-01 | P1: Lista "meus grupos" | Design | Pending |
| MOB-09-02 | P1: Estado vazio / erro da lista de grupos | Design | Pending |
| MOB-09-03 | P1: Lista de encontros do grupo | Design | Pending |
| MOB-09-04 | P1: Lista de materiais do encontro, filtrada por papel | Design | Pending |
| MOB-09-05 | P1: Abrir material (link ou rich text) | Design | Pending |
| MOB-09-06 | P1: Roster + presença já registrada na tela do líder | Design | Pending |
| MOB-09-07 | P1: Registrar presença (líder) | Design | Pending |
| MOB-09-08 | P1: Erro ao registrar presença preserva seleção | Design | Pending |
| MOB-09-09 | Backend: `GET /small-groups/mine` (novo) | Design | Pending |
| MOB-09-10 | Backend: `member` liberado em `GET /small-groups/:groupId/meetings` | Design | Pending |
