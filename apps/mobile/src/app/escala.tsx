// Tela Escala (MOB-04, MHR-03) — lista os próximos slots do usuário (AC 1),
// permite confirmar/recusar um slot pendente (AC 2, atualização otimista
// local — sem refetch, mesmo princípio de
// apps/web/src/app/(admin)/voluntarios/page.tsx:169-232) e fazer check-in de
// um slot confirmado (AC 3, botão some após sucesso).
//
// Rota empilhada (`.specs/features/mobile-home-redesign/design.md`): saiu do
// menu inferior (`(tabs)/index.tsx`, que agora é a Home) para cá, mesmo
// padrão de `biblia/` e `indisponibilidade.tsx` — o `Stack` já dá
// header/voltar de graça (`src/app/_layout.tsx`), então não precisa mais do
// `BrandHeader` que a aba desenhava. Conteúdo 1:1 do que a aba fazia antes,
// só o container muda.
//
