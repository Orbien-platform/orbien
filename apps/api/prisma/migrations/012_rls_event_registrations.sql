-- =============================================================================
-- 012_rls_event_registrations.sql — RLS das inscrições em evento (PROD-16)
--
...
BEGIN
  ...
  RAISE NOTICE '012_rls_event_registrations: % policy(s) simétrica(s) em event_registrations', n;

  IF n <> 1 THEN
    RAISE EXCEPTION '012_rls_event_registrations: esperava 1 policy tenant_congregation_isolation simétrica em event_registrations, encontrei %', n;
  END IF;
END $$;
