...
# Mesmo caso de 012/014/015/016/018, mais uma feature depois:
# `bible_verse_marks` (biblia-nvi-marcacoes-mobile) é tabela nova, nasce com a
# policy de congregação e não tem `tenant_isolation` para o passo 4 derrubar.
# Depende de app_congregation_allowed() (003).
...
BEGIN
  ...
  -- 020: bible_verse_marks (biblia-nvi-marcacoes-mobile), mesmo caso de
  -- 012/014/015/016/018 — nasceu com a policy de congregação, sem
