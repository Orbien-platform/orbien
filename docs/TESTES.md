...
133 testes e deve falhar alto se eles sumirem. Os outros precisam da flag
...
`DATABASE_URL`/`DIRECT_URL`; no CI ele continua verde com os 133 testes. Para
...
npm run test:rls -w orbien-backend   # 133 testes verdes
node scripts/check-skills.mjs
...
**Não está mais**: `npm run test:rls -w orbien-backend` fecha em 133 testes
verdes (o plano falava em 39, depois 54, 118, 125 — a suíte cresceu desde
