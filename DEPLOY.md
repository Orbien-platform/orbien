...
```bash
curl -X POST https://web.useorbien.com/api-proxy/auth/login \
...
1. Confirmar que os domínios customizados (`web.useorbien.com`,
   `admin.useorbien.com` e `useorbien.com`) apontam para os projetos
   novos.
